  ...
  return (
    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 my-10 mx-10" id="Services">
        {ServiceCard.map((item, index)=>(
            <Link to={`/services/${item.id}`} key={index} className="flex flex-col items-center justify-center sm:justify-start sm:items-start p-4 text-center sm:text-start hover:shadow-md hover:bg-white rounded-lg transition duration-300">
